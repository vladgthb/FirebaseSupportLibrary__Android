...
public abstract class FirebaseStorageAuthenticationActivity extends Authentication {

//    Internal TAG Variable
    private static final String TAG = FirebaseStorageAuthenticationActivity.class.getSimpleName();
